    ...
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
        ...
        >
            ...
            hover:bg-gray-950 active:scale-105 transition cursor-pointer">
                Contact me here <BsArrowRight className="opacity-70 group-hover:translate-x-1 transition mt-0.5"/>
            </Link>
            <a className="group bg-white text-black px-7 py-3 flex items-center gap-2 rounded-full 
            outline-none focus:scale-110 hover:scale-110 hover:bg-white active:scale-105 transition 
            ...
            href="https://www.linkedin.com/in/dany-irfansyah-110509222/?original_referer=&originalSubdomain=id" target="_blank"> 
               <BsLinkedin />
            </a>
            <a className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full 
            focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition 
            cursor-pointer border border-black/10"
            href="https://github.com/danyirfansyah" target="_blank">
                <BsGithub />
            </a>
        </motion.div>
    </section>
