...
export default function Header() {
  ...
  <header className="z-[999] relative">
    <motion.div 
        ...
        rounded-none border border-white border-opcaity-40 bg-white 
        bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.
        5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full"
